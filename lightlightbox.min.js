...
var n=!1,h=!1
if("lightbox"==o)e=t.getAttribute("href"),"#"!==e&&e!==window.location.href+"#"||(e=this.getImageAttrInNode(t.childNodes,"src")),s=this.getImageAttrInNode(t.childNodes,"attribute"),this.galleryCount=this.lightboxGallery.length,this.currentImage=i
...
for(var h=0;h<o.length;h++)i[e]===o[h]&&(that.imageClick(i[e],h),s=!0)}else!i[e].getAttribute("data-lightbox")||"gallery"!==i[e].getAttribute("data-lightbox")&&"content"!==i[e].getAttribute("data-lightbox")||(that.imageClick(i[e]),s=!0)
